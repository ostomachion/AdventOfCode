...
public static class Grid
{
    ...
    public static SparsePlaneGrid2D<T> Infinite2D<T>() where T : notnull => SparsePlaneGrid2D<T>.Infinite;
    public static SparsePlaneGrid3D<T> Infinite3D<T>() where T : notnull => SparsePlaneGrid3D<T>.Infinite;
}
